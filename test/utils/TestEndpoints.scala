...
trait TestEndpoints {
  ...
  val changeSignatoryNameEndpoint: String               = s"$accountFrontendRoutePrefix/change-signatory-name"
  ...
  val removeSignatoryEndpoint: String                   = s"$accountFrontendRoutePrefix/remove-signatory"
  ...
  val declarationForChangesEndpoint: String             = s"$accountFrontendRoutePrefix/declaration-for-changes"
  ...
  def liaisonOfficerPhoneNumberEndpointFor(id: String): String = s"$liaisonOfficerPhoneNumberEndpoint?id=$id"
