...
import uk.gov.hmrc.disaaccountfrontend.utils.WiremockHelper.{wiremockHost, wiremockPort}
...
trait BaseIntegrationSpec
  ...
  def config: Map[String, Any] =
    Map(
      ...
      "microservice.services.disa-account.port"           -> wiremockPort.toString,
      "mongodb.uri"                                       -> "mongodb://localhost:27017/disa-account-frontend-it",
