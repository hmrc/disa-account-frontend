...
case object PeerToPeerPlatformNumberPage extends GuardedPage with PageWithAnswers[String] {

  def canBeAccessedWith(answers: Answers): Boolean = answers.p2pPlatform.isDefined
  ...
  def saveAnswerAndHandleDependents(request: DataRequest[_], newAnswer: String): SessionUpdates = {
    ...
    existingUpdates.copy(p2pPlatformNumber = Assign(newAnswer))
  }
}
