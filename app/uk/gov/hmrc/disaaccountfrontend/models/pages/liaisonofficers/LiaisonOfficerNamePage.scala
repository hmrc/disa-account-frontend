...
import uk.gov.hmrc.disaaccountfrontend.models.pages.{ConfiguredGuardedPage, IdentifiedPage, PageWithAnswers}
...
final case class LiaisonOfficerNamePage(id: String)
  ...
  override def saveAnswerAndHandleDependents(request: DataRequest[_], newAnswer: String): SessionUpdates = {
    ...
    val updatedLiaisonOfficers = existingSection.upsertName(id, newAnswer)
