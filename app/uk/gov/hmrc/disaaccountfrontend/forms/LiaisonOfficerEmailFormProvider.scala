...
import uk.gov.hmrc.disaaccountfrontend.forms.LiaisonOfficerEmailFormProvider.emailRegex
...
object LiaisonOfficerEmailFormProvider {
  private[forms] val emailRegex =
